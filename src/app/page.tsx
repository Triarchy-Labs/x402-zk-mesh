			...
			{booted && (
				<>
					...
					>
						...
						<div style={{ position: "absolute", top: "-4rem", left: "-4rem", right: "-4rem", bottom: "-4rem", zIndex: -1 }} />
					...
					<motion.a
						...
						style={{
							position: "fixed",
							bottom: "var(--pos-fab-bottom)",
							right: "calc(var(--pos-fab-right) + 17rem)",
							zIndex: 100,
							width: "4.8rem",
							height: "4.8rem",
							display: "flex",
					...
					>
						{/* Invisible proximity hitbox */ }
						<div style={{ position: "absolute", top: "-4rem", left: "-4rem", right: "-4rem", bottom: "-4rem", zIndex: -1 }} />
						<svg height="2.4rem" width="2.4rem" viewBox="0 0 16 16" fill="currentColor">
