            ...
            <AnimatePresence mode="wait">
                {glitching ? (
                    <motion.div 
                        ...
                        exit={{ opacity: 0 }}
                        className="absolute inset-0 flex items-center justify-center z-50 text-[#ffaa00] font-bold text-center tracking-widest text-[1.5rem]"
                        style={{ textShadow: "0 0 20px #ffaa00, 0 0 10px #ffaa00" }}
                    >
                        <motion.span
                    ...
                    >
                        <div className="text-[1.2rem] text-white/30 uppercase tracking-[0.2em] flex justify-between w-full pb-1 border-b border-white/5">
                            ...
                            <span className="text-[#ffaa00] drop-shadow-[0_0_5px_#ffaa00]">{Math.round(safeProgress)}%</span>
                        </div>
                                ...
                                return (
                                    <div 
                                        ...
                                        className={`w-full max-w-[12px] h-4 rounded-[1px] relative overflow-hidden ${
                                            isFilled ? "bg-[#ffaa00] shadow-[0_0_10px_rgba(255, 170, 0,0.6)]" : "bg-white/5 border border-white/10"
                                        }`}
                                    >
